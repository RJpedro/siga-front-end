...
import GradesComponent from "@/components/grades.vue";
import AbsenseComponent from "@/components/absense.vue";
</script>
...
<template>
    <section class="dashboard-area bg-siga-1 w-[86%] h-auto absolute right-0 top-0 flex flex-col overflow-y-auto">
        <div class="flex justify-between px-14 pt-8">
            <h1 class="text-black text-3xl">Dashboard</h1>
